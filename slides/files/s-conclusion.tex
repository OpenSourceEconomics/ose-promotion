		...
		\begin{tabularx}{1\textwidth}{>{\centering\arraybackslash}m{1.5cm} >{\centering\arraybackslash}m{3.7cm}}
			...
			\href{http://bit.ly/ose-github}{\texttt{http://bit.ly/ose-github}} \\[1cm]
			 \href{http://bit.ly/ose-zulip}{\includegraphics[scale=0.35]{material/crop-zulip-mark.png}} & 
			  ...
			  \href{https://twitter.com/open_econ}{\includegraphics[scale=0.05]{material/crop-twitter-mark.png}} & \vspace{0.1cm}
...
\hspace{1.3cm}\includegraphics[width=0.25\textwidth]{material/ose-logos.pdf}
